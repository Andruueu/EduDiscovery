...
export default function MarineAnimalCard({ name }) {
  ...
  return (
    <>
      {/* Card principal */}
      <div className="bg-blue-100 dark:bg-blue-800 hover:bg-blue-200 dark:hover:bg-blue-700 transition-all rounded-xl shadow-md p-4 text-center flex flex-col items-center h-full">
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="bg-white dark:bg-blue-900 text-gray-900 dark:text-white rounded-lg max-w-lg w-full p-6 shadow-2xl relative"
